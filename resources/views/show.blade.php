<x-app-layout>
        ...
        <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
            ...
            <div class="w-full mx-2 md:mx-4">
                ...
                <div class="text-gray-600 mt-3">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt libero a odit voluptatibus rem adipisci enim veniam. Quam quas sint eaque nemo quasi deserunt, nobis et minus autem esse libero!
                </div>

                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                    <div class="flex items-center text-xs text-gray-400 font-semibold space-x-2">
                        <div class="hidden md:block font-bold text-gray-900">Jane Doe</div>
    ...
    <div class="buttons-container flex items-center justify-between mt-6">
                ...
                >
                    <form action="#" class="space-y-4 px-4 py-6">
                        ...
                        <div class="flex flex-col md:flex-row items-center md:space-x-3">
                            <button type="button" class="flex items-center justify-center w-full md:w-1/2 h-11 text-sm text-white bg-blue font-semibold rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3">
                                Post Comment
                            </button>
                        ...
                        <div class="space-y-2">
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" checked="" class="bg-gray-200 text-gray-500 border-none" name="radio-direct" value="1">
        ...
        <div class="hidden md:flex items-center space-x-3">
            ...
            <button type="button" class="w-32 h-11 text-sm bg-gray-200 font-semibold uppercase rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3">
                <span>Vote</span>
            </button>
        </div>
            ...
            <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
                ...
                <div class="w-full md:mx-4">
                    ...
                    <div class="text-gray-600 mt-3 line-clamp-3">
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quaerat voluptas rem atque placeat dolorum?
                    </div>

                    <div class="flex items-center justify-between mt-6">
                        <div class="flex items-center text-xs text-gray-400 font-semibold space-x-2">
                            <div class="text-bold text-gray-900">Jane Doe</div>
                            <div>&bull;</div>
                            <div>10 hours ago</div>
                        </div>
                        <div
                        ...
                        >
                            ...
                            >
                                ...
                                <ul
                                    ...
                                    @click.away="isOpen = false"
                                    @keydown.escape.window="isOpen = false"
                                    class="absolute z-10 w-44 text-left font-semibold bg-white shadow-dialog rounded-xl py-3 md:ml-8 top-8 md:top-6 right-0 md:left-0 z-10"
                                >
                                    <li><a href="#" class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">Mark as Spam</a></li>
                                    <li><a href="#" class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">Delete Post</a></li>
                                </ul>
        ...
        {{-- <div class="is-admin comment-container relative bg-white rounded-xl flex mt-4">
            <div class="flex flex-1 px-4 py-6">
                <div class="flex-none">
                    ...
                    <div class="text-center text-blue text-xxs font-bold uppercase py-1">Admin</div>
                </div>
                <div class="w-full mx-4">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        <div class="flex items-center text-xs text-gray-400 font-semibold space-x-2">
                            <div class="text-bold text-blue">Amanda</div>
                            <div>&bull;</div>
                            <div>10 hours ago</div>
                        </div>
        ...
        {{-- <div class="comment-container relative bg-white rounded-xl flex mt-4">
            <div class="flex flex-1 px-4 py-6">
                ...
                <div class="w-full mx-4">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        <div class="flex items-center text-xs text-gray-400 font-semibold space-x-2">
                            <div class="text-bold text-gray-900">Linda Belcher</div>
                            <div>&bull;</div>
                            <div>10 hours ago</div>
                        </div>
                        <div class="flex items-center space-x-2">
