...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        ...
        <main class="container mx-auto max-w-custom flex" style="max-width: 1000px">
            <div class="w-70 mr-5">
                Add Idea Form goes here. Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas recusandae incidunt facilis, dignissimos ut consequatur qui, nostrum mollitia et velit, labore dolorum saepe doloremque consequuntur minus unde? Mollitia eligendi cum maxime. Mollitia autem fugit voluptate possimus, cumque corrupti. Delectus, odio!
            </div>
            <div class="w-175">
